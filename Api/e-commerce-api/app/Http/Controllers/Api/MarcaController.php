    ...
    public function store(Request $req)
    {
        ...
        try {
            ...
            if ($id > 0 && $req->hasFile('imagen')) {
                ...
                $nuevo_nombre = "marca_" . $id . "." . $extension; // Nombre único
                $ruta = $imagen->storeAs('imagenes_marcas', $nuevo_nombre, 'public'); // Guardar en storage
...
public function update(Request $req, $id)
{
    ...
    try {
        ...
        if (!empty($updateData)) {
            DB::table('marcas')->where('id', $id)->update($updateData);
        }
